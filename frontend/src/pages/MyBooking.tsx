...
const MyBookings = () => {
  ...
  return (
    <div className="space-y-5">
      ...
      {hotels.map((hotel) => (
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_3fr] border border-slate-300 rounded-lg p-4 gap-5">
          <div className="lg:w-full lg:h-[150px] rounded-md overflow-hidden">
          ...
          <div className="flex flex-col gap-4 overflow-y-auto max-h-[300px]">
            <div className="text-2xl font-bold">
              ...
              <div className="text-sm font-[500] text-slate-600">
            ...
            {hotel.bookings.map((booking) => (
              <div>
                ...
                <div>
                  ...
                  <span>
                    {booking.adultCount} {booking.adultCount <= 1 ? <>adult</> : <>adults</>}, {booking.childCount}{" "}
